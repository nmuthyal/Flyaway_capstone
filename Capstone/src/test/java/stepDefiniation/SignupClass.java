...
public class SignupClass {
	...
	public void SignUp() {
	    ...
	    driver.findElement(By.name("email_id")).sendKeys("nmut@user.com");
		driver.findElement(By.name("pwd")).sendKeys("nmut");
		driver.findElement(By.name("pwd2")).sendKeys("nmut");
		driver.findElement(By.name("name")).sendKeys("nmut");
